---
type: "Architecture"
title: "Lakehouse Landscape"
description: "A source-backed landscape of lakehouse architecture and selected managed and open-source implementations."
...
- [Data Platforms](../DataPlatforms/platforms.md)
- [Data Engineering Reference Architectures](../ReferenceArchitecture/open-source-data-stack.md)

## References

- [Google Cloud data lakehouse](https://cloud.google.com/solutions/data-lakehouse) — Google Cloud's managed lakehouse overview.
- [Databricks lakehouse architecture](https://docs.databricks.com/aws/en/lakehouse-architecture/well-architected) — architectural principles and guidance.
- [DuckLake](https://ducklake.select/) — an open lakehouse format using Parquet and a SQL catalog.
- [Dremio Community Edition](https://www.dremio.com/community-edition/) — an open lakehouse implementation.
